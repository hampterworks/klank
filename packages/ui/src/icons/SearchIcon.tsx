...
const SearchIcon: React.FC<React.ComponentPropsWithoutRef<'svg'>> = ({...props}) =>
  <SvgWrapper width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
