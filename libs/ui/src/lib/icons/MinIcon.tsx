...
export const MinIcon: React.FC<React.ComponentPropsWithoutRef<'svg'>> = (props) =>
  <svg width="12px" height="12px" viewBox="0 -12 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">

    <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <g id="Icon-Set-Filled" transform="translate(-414.000000, -1049.000000)" fill="currentColor">
